...
import numpy as np
from .transformer_encoder_visualization import TransformerEncoderLayer, LayerNorm, TransformerEncoder
from .gcat_visualization import CrossAttention, CrossAttentionLayer
import pdb
...
class ZSGR(nn.Module):
    ...
    def forward(self, samples, is_training=True, clip_input=None):
        ...
        memory, weight_encoder = self.encoder(src, pos=pos_embed)# shape = [B, HW, 256]
        ...
        if self.args.encoder_only:
            ...
            # pdb.set_trace()
            gcat_output, weight, weight_2 = self.gated_cross_attention(memory_in_clip_dim, clip_context)
        ...
        if self.args.encoder_only:
            ...
            produce = {
                ...
                'weight':  weight[:, :, 1:].unflatten(2, (7, 7)),
                'weight_2': weight_2.unflatten(2,(7,7)),
                'weight_encoder': weight_encoder.unflatten(2,(7,7))
            }
