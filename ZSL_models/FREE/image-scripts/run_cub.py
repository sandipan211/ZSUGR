...
--nepoch 501 --ngh 4096 --ndh 4096 --lr 0.0001 --classifier_lr 0.001 --lambda1 10 --critic_iter 1 --dataroot data --dataset CADDY \
 --a1 1 --a2 1 --feed_lr 0.00001 --dec_lr 0.0001 --loop 2 \
--nclass_all 16 --nclass_seen 10 --batch_size 16 --nz 512 --latent_size 512 --attSize 512 --resSize 2048  \
