...
class CLASSIFIER:
    # train_Y is interger 
    def __init__(self, _train_X, _train_Y, data_loader, _nclass, _cuda, _lr=0.001, _beta1=0.5, _nepoch=50, _batch_size=16, generalized=True, netDec=None, dec_size=4096, dec_hidden_size=4096):
    ...
    def fit_zsl(self):
        ...
        for epoch in range(self.nepoch):
            ...
            if acc > best_acc:
                ...
                best_model = copy.deepcopy(self.model.state_dict())
        new_acc_per_class = {self.label_dict[int(key)]: value for key, value in best_acc_per_class.items()}
