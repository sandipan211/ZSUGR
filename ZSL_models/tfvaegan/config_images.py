...
parser.add_argument('--dataset', default='CADDY', help='CADDY')
...
parser.add_argument("--datadir", type=str,default='/workspace/arijit/sandipan/zsgr_caddy/hariansh/ZSL_models/tfvaegan/')
###
